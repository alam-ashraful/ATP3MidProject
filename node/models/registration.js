...
var insertuser = function(user, callback){
	...
	var sql = "INSERT INTO user (id, username, password, email, contact, address,role) VALUES ('null','"+user.username+"', '"+user.password+"','"+user.email+"','"+user.contact+"','"+user.address+"','user')";
